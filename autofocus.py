...
class Autofocus2D(Conv2D):
    ...
    def __init__(self, dilations, filters, kernel_size, activation=None,
                 attention_kernel_size=(3, 3), attention_filters=None,
        ...
        kwargs : (dict)
            Passed to tf.keras.layers.Conv2D, for instance...
        ...
        kwargs["dilation_rate"] = (1, 1)
        kwargs["padding"] = "SAME"

        # Init base tf 2D Conv class
        super(Autofocus2D, self).__init__(filters=filters,
    ...
    def build_attention(self, input_shape, input_dim):
        ...
        l2_kernel_shape = (1, 1) + (self.attention_filters, len(self.dilations))
    ...
    def build(self, input_shape):
        """
        Reimplementation of tf.keras.layers.Conv2D creating multiple conv ops
